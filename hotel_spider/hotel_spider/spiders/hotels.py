...
class HotelsSpider(scrapy.Spider):
    ...
    def parse_reviews(self,response):
        ...
        for review_tab in review_tabs:
            bubbles = review_tab.xpath('div[@class="location-review-review-list-parts-RatingLine__container--2bjtw"]/div[@class="location-review-review-list-parts-RatingLine__bubbles--GcJvM"]/span/@class').extract_first()
            review = review_tab.xpath('div[@class="location-review-review-list-parts-ExpandableReview__containerStyles--1G0AE"]//q/span/text()').extract_first()
        ...
        yield Request(absolute_next_url, callback=self.parse_reviews)
